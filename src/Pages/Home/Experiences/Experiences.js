...
const Experiences = () => {
    ...
    const size = 10;
    useEffect(() => {
        fetch(`https://fierce-beyond-59562.herokuapp.com/logs?page=${page}&&size=${size}`)
            .then(res => res.json())
            .then(data => {
                setBlogs(data.blogs)
        ...
        <>
            <div className="bg-white">
                <div className="max-w-2xl mx-auto py-16 px-4 sm:py-20 sm:px-6 lg:max-w-7xl lg:px-8">
                    <h2 className="text-5xl font-bold text-medium text-gray-900 text-center mb-12 pb-5">Travelers Experiences</h2>
